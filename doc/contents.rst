...
- A `PDF <../latex/caribu.pdf>`_ version of |caribu| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:caribu:caribu>`__ wiki.
