...
Ready to contribute? Here's how to set up `caribu` for local development.

1. Fork the `caribu` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/caribu.git
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/openalea-incubator/caribu/pull_requests
...
.. _issues: https://github.com/openalea-incubator/caribu/issues
