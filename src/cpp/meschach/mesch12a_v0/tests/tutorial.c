...
double rk4( VEC * (*f)(double, VEC *, VEC *), double t,VEC *x, double h)
{
...
double rk4_var(VEC * (*f)(double, VEC *, VEC *), double t, VEC *x, double h)
{
