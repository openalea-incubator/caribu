...
#ifdef SPARSE
SPMAT  *gen_non_symm(int m,int n)
{
    SPMAT      *A;
...
void main(int argc, char **argv)
{
   ...
   mem_attach_list(FOO_LIST,FOO_NUM_TYPES,foo_type_name,
		   (int (**)(void *))foo_free_func,foo_info_sum);
