...
/* zero & copy pour Zindows HA 03 2001 
#ifndef WIN32
#define	MEM_COPY(from,to,size)	bcopy((char *)(from),(char*)(to),(int)(size))
#define	MEM_ZERO(where,size)	bzero((char *)(where),(int)(size))
#else
#define MEM_COPY(from,to,size)	CopyMemory((char *)(from),(char*)(to),(int)(size))
#define MEM_ZERO(where,size)	ZeroMemory((char *)(where),(int)(size))
#endif
*/
