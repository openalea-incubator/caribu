...
# This file has been generated at Fri Aug 03 14:11:27 2012
...
__all__ = ['LIE', 'CaribuScene_functional_newFileCaribuScene', '_130567728', 'reduceDict_reduceDict', '_130567760', 'CaribuScene_functional_generate_scene', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_functional_newCaribuScene', 'CarribuZenithParSoil', 'filterby_filterby', 'mtg_updateMTG', 'CaribuScene_functional_periodise', 'PARaggregators_PARaggregators', 'label_decode_label', 'CaribuScene_functional_WriteCan', '_130566864', 'vcaributest2', 'CaribuScene_functional_newObjCaribuScene', 'Canestra_Canestra', 'CaribuScene_functional_addShapes', 'mtg_to_canestra', 'CaribuZenithPar', 'CaribuScene_functional_GenOutput', 'label_encode_label', '_196407600', 'CaribuScene_functional_runCaribu', 'caribu_vcaribu', '_130567792', 'mydict_mydict', 'CaribuScene_functional_addSoil', 'CaribuScene_functional_output_by_id', 'CaribuScene_functional_getIncidentEnergy', 'selectOutput_selectOutput', 'PARsums', 'Tutorial', 'debug', 'lightString_lightString', 'CaribuScene_functional_getEi']
...
_130567728 = CompositeNodeFactory(name='Caribu with turtle',
                             description='',
                             category='demo',
                             doc='',
                             inputs=[],
...
_130567760 = CompositeNodeFactory(name='vcaribu_test',
...
_130566864 = CompositeNodeFactory(name='Directional gap fraction',
...
_196407600 = CompositeNodeFactory(name='Tutorial getData',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
   ...
   8: {'position': [162.7772238509744, 68.20084718132361], 'userColor': None, 'useUserColor': False},
   ...
   21: {'position': [78.20411779061345, 23.640823558122655], 'userColor': None, 'useUserColor': False},
...
_130567792 = CompositeNodeFactory(name='Povray with periodise',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
...
Tutorial = CompositeNodeFactory(name='Tutorial',
   ...
   27: ('alinea.caribu.data', 'zenith.light')},
                             elt_connections={  30978896: (24, 0, 3, 0),
   30978908: (13, 0, 16, 0),
   30978920: (3, 0, 4, 0),
   30978932: (18, 0, 15, 0),
   30978944: (18, 0, 5, 3),
   ...
   24: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x08021390> : "f331s1_100plantes.can"',
          'hide': True,
          'id': 24,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   25: {  'block': False,
          'caption': 'maize.8',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x08021430> : "maize.8"',
          'hide': True,
          'id': 25,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   26: {  'block': False,
          'caption': 'par.opt',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x080214F0> : "par.opt"',
          'hide': True,
          'id': 26,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   27: {  'block': False,
          'caption': 'zenith.light',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x08021410> : "zenith.light"',
          'hide': True,
          'id': 27,
          'lazy': True,
          'port_hide_changed': set([2]),
