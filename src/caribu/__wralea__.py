...
# This file has been generated at Wed Dec 21 11:24:27 2011
...
__all__ = ['LIE', 'CaribuScene_getIncidentEnergy', 'vcaribuOut_adaptor_vcaribuOut_adaptor', 'selectOutput_selectOutput', 'reduceDict_reduceDict', 'vcaribu_adaptor_vcaribu_adaptor', 'addSoil_addSoil', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_newFileCaribuScene', 'Caribu', 'filterby_filterby', 'mtg_updateMTG', 'PARaggregators_PARaggregators', 'CaribuScene_newObjCaribuScene', 'Periodise_Periodise', 'vcaributest2', 'Canestra_Canestra', 'GenOutput_GenOutput', 'vcaribu_vcaribu', 'mtg_to_canestra', 'CaribuZenithPar', '_60287600', 'mydict_mydict', 'CarribuZenithParSoil', 'ScatteringOptions_ScatteringOptions', '_60287216', 'PARsums', 'lightString_lightString', 'debug', 'WriteCan_WriteCan', 'Tutorial']
...
selectOutput_selectOutput = Factory(name='selectOutput',
                ...
                inputs=[{'interface': None, 'name': 'EnergyLabel', 'value': None, 'desc': ''}, {'interface': IEnumStr(enum=['Eabs', 'Area', 'Eabsm2', 'EiInf', 'EiSup', 'Opt', 'Opak', 'Plt', 'Elt', 'label']), 'name': 'variable', 'value': None, 'desc': ''}],
...
CaribuZenithPar = CompositeNodeFactory(name='CaribuZenithPar',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  3: {'position': [191.25, 256.25], 'userColor': None, 'useUserColor': False},
   5: {'position': [49.537176274018378, 112.23266499582289], 'userColor': None, 'useUserColor': False},
   6: {'position': [145.0, 186.25], 'userColor': None, 'useUserColor': False},
   7: {'position': [311.25, 77.5], 'userColor': None, 'useUserColor': False},
   8: {'position': [210.0, 75.0], 'userColor': None, 'useUserColor': False},
   9: {'position': [307.54089979550093, 5.4192229038854798], 'userColor': None, 'useUserColor': False},
   10: {'position': [191.25, 7.5], 'userColor': None, 'useUserColor': False},
   '__in__': {'position': [109.9202172096909, -26.331871345029242], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [210.3125, 402.0], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_60287600 = CompositeNodeFactory(name='vcaribu_test',
...
CarribuZenithParSoil = CompositeNodeFactory(name='CarribuZenithParSoil',
   ...
   5: {  'block': False,
         ...
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 157.95389048991359,
         'posy': 243.82564841498561,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  3: {'position': [198.14481268011528, 304.51368876080693], 'userColor': None, 'useUserColor': False},
   4: {'position': [56.8620711240156, 101.42964038337919], 'userColor': None, 'useUserColor': False},
   5: {'position': [157.95389048991359, 243.82564841498561], 'userColor': None, 'useUserColor': False},
   6: {'position': [145.0, 186.25], 'userColor': None, 'useUserColor': False},
   7: {'position': [311.25, 77.5], 'userColor': None, 'useUserColor': False},
   8: {'position': [210.0, 75.0], 'userColor': None, 'useUserColor': False},
   9: {'position': [301.25, 7.5], 'userColor': None, 'useUserColor': False},
   10: {'position': [191.25, 7.5], 'userColor': None, 'useUserColor': False},
   '__in__': {'position': [137.36311239193083, -31.391210374639769], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [186.49405619596541, 399.0], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_60287216 = CompositeNodeFactory(name='Directional gap fraction',
...
PARsums = CompositeNodeFactory(name='PARsums',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {  'position': [69.723581400544504, 92.928643495772064],
         'useUserColor': False,
         'userColor': None},
   3: {  'position': [-171.27406947106351, 267.64489661153095],
         'useUserColor': False,
         'userColor': None},
   ...
   7: {  'position': [-205.89256249672724, 20.94633804466028],
         'useUserColor': False,
         'userColor': None},
   8: {  'position': [-309.57221137129977, 273.94844010782913],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [-280.13514032699686, 232.91545030872749],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [-324.0, 197.96583763784142],
          'useUserColor': False,
          'userColor': None},
   11: {  'position': [-297.89003527062096, 325.68379141083562],
          'useUserColor': False,
          'userColor': None},
   12: {  'position': [-316.56072386333619, 20.94633804466028],
          'useUserColor': False,
          'userColor': None},
   13: {  'position': [188.59205589920793, 93.316978325802864],
          'useUserColor': False,
          'userColor': None},
   ...
   15: {  'position': [288.9881219048475, 272.21347410652197],
          'useUserColor': False,
          'userColor': None},
   16: {  'position': [318.42519294915041, 231.18048430742033],
          'useUserColor': False,
          'userColor': None},
   17: {  'position': [300.67029800552632, 323.94882540952847],
          'useUserColor': False,
          'userColor': None},
   18: {  'position': [290.10781562842578, 169.22734965626117],
          'useUserColor': False,
          'userColor': None},
   19: {  'position': [307.36655430337078, 20.94633804466028],
          'useUserColor': False,
          'userColor': None},
   20: {  'position': [-36.765398181095748, 266.48545429252465],
          'useUserColor': False,
          'userColor': None},
   21: {  'position': [-6.5100385919359951, 222.99759885885271],
          'useUserColor': False,
          'userColor': None},
   22: {  'position': [-25.083222080416931, 326.40369104409871],
          'useUserColor': False,
          'userColor': None},
   23: {  'position': [-35.645704457517468, 186.41140909825305],
          'useUserColor': False,
          'userColor': None},
   24: {  'position': [-18.386965782572588, 20.94633804466028],
          'useUserColor': False,
          'userColor': None},
   25: {  'position': [442.82636833791832, 289.39753354851393],
          'useUserColor': False,
          'userColor': None},
   26: {  'position': [472.26343938222124, 248.36454374941229],
          'useUserColor': False,
          'userColor': None},
   ...
   29: {  'position': [435.8378558458819, 20.94633804466028],
          'useUserColor': False,
          'userColor': None},
   30: {  'position': [86.879575118491459, 416.43814419434943],
          'useUserColor': False,
          'userColor': None},
   31: {  'position': [78.837290383062424, 460.79036965272695],
          'useUserColor': False,
          'userColor': None},
   32: {  'position': [-74.606441869508018, 74.170676445996378],
          'useUserColor': False,
          'userColor': None},
   33: {  'position': [-119.28959008736796, 33.493043961112988],
          'useUserColor': False,
          'userColor': None},
   34: {  'position': [-92.361336813132112, 166.93901754810452],
          'useUserColor': False,
          'userColor': None},
   35: {  'position': [-111.03202540584729, -153.24752925875561],
          'useUserColor': False,
          'userColor': None},
   50: {  'position': [180.23928841047382, 809.40791554703515],
          'useUserColor': False,
          'userColor': None},
   51: {  'position': [305.40546091774723, 971.28949865644211],
          'useUserColor': False,
          'userColor': None},
   52: {  'position': [388.84957592259627, 922.89191195362969],
          'useUserColor': False,
          'userColor': None},
   53: {  'position': [278.70334411619558, 892.85203055188413],
          'useUserColor': False,
          'userColor': None},
   54: {  'position': [317.08763701842611, 1023.0248499594486],
          'useUserColor': False,
          'userColor': None},
   '__in__': {  'position': [74.131719691110618, -115.0],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [74.131719691110618, 510.28044722759307],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
Tutorial = CompositeNodeFactory(name='Tutorial',
   ...
   19: ('openalea.data structure', 'float')},
                             elt_connections={  10019780: (13, 1, 15, 2),
   10019792: (16, 0, 18, 0),
   10019804: (17, 0, 19, 0),
   10019816: (14, 0, 5, 2),
   10019828: (19, 0, 5, 4),
   ...
   10020044: (2, 0, 5, 0)},
         ...
         'caption': 'Caribu',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0B7F0BF0> : "Caribu"',
         'hide': True,
         'id': 2,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   3: {  'block': False,
         'caption': 'FileCaribuScene',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0B7F0AF0> : "FileCaribuScene"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'Plot CaribuScene',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0B81E250> : "Plot CaribuScene"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   5: {  'block': False,
         'caption': 'ViewMapOnCan',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0B81E350> : "ViewMapOnCan"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
         'posx': 367.06743030648192,
   ...
   6: {  'block': False,
         'caption': 'f331s1_100plantes.can',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0B81E370> : "f331s1_100plantes.can"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   7: {  'block': False,
         'caption': 'maize.8',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0B81E470> : "maize.8"',
         'hide': True,
         'id': 7,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   8: {  'block': False,
         'caption': 'par.opt',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0B81E530> : "par.opt"',
         'hide': True,
         'id': 8,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   9: {  'block': False,
         'caption': 'zenith.light',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x0B81E450> : "zenith.light"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   10: {  'block': False,
          'caption': 'Write_Table',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x063988B0> : "Write_Table"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   11: {  'block': False,
          'caption': 'LIE',
          'delay': 0,
          'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0B7F0830> : "LIE"',
          'hide': True,
          'id': 11,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   12: {  'block': False,
          'caption': 'addSoil',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0B7F0A30> : "addSoil"',
          'hide': True,
          'id': 12,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   13: {  'block': False,
          'caption': 'selectOutput',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0B7F0CB0> : "selectOutput"',
          'hide': True,
          'id': 13,
          'lazy': True,
          'port_hide_changed': set(),
   ...
   14: {  'block': False,
          'caption': '1',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04280B70> : "int"',
          'hide': True,
          'id': 14,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 395.19512719420374,
          'posy': 557.58350938610783,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   15: {  'block': False,
          'caption': 'colorScale',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0B81E310> : "colorScale"',
          'hide': True,
          'id': 15,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 564.95436551557134,
          'posy': 621.52116088048047,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   16: {  'block': False,
          'caption': 'min',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0421F6B0> : "min"',
          'hide': True,
          'id': 16,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 467.91545663099549,
   ...
   17: {  'block': False,
          'caption': 'max',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x0421F830> : "max"',
          'hide': True,
          'id': 17,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 510.53419611406684,
          'posy': 518.87206808444103,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   18: {  'block': False,
          'caption': '0.0',
          'delay': 0,
          'factory': '<openalea.core.node.NodeFactory object at 0x04280AB0> : "float"',
          'hide': True,
          'id': 18,
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 469.60352077632126,
          'posy': 558.80768301985836,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   19: {  'block': False,
          ...
          'lazy': True,
          'port_hide_changed': set(),
          'posx': 512.41424711877164,
          'posy': 556.50366064143952,
          'priority': 0,
          'use_user_color': False,
          'user_application': None,
          'user_color': None},
   ...
   5: {  'position': [367.06743030648192, 621.9407543154739],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [-21.25, 16.25], 'useUserColor': False, 'userColor': None},
   7: {  'position': [205.0, 17.5], 'useUserColor': False, 'userColor': None},
   8: {  'position': [271.25, 66.25], 'useUserColor': False, 'userColor': None},
   9: {  'position': [88.75, 67.5], 'useUserColor': False, 'userColor': None},
   10: {  'position': [577.49999999999989, 472.49999999999989],
          'useUserColor': False,
          'userColor': None},
   ...
   14: {  'position': [395.19512719420374, 557.58350938610783],
          'useUserColor': False,
          'userColor': None},
   15: {  'position': [564.95436551557134, 621.52116088048047],
          'useUserColor': False,
          'userColor': None},
   16: {  'position': [467.91545663099549, 519.8199993858218],
          'useUserColor': False,
          'userColor': None},
   17: {  'position': [510.53419611406684, 518.87206808444103],
          'useUserColor': False,
          'userColor': None},
   18: {  'position': [469.60352077632126, 558.80768301985836],
          'useUserColor': False,
          'userColor': None},
   19: {  'position': [512.41424711877164, 556.50366064143952],
          'useUserColor': False,
          'userColor': None},
