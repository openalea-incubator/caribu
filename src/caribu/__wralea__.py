...
# This file has been generated at Thu Oct 27 16:39:32 2011
...
__all__ = ['LIE', 'CaribuScene_getIncidentEnergy', 'vcaribuOut_adaptor_vcaribuOut_adaptor', 'reduceDict_reduceDict', 'vcaribu_adaptor_vcaribu_adaptor', 'addSoil_addSoil', 'mtg_updateMTG', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_newFileCaribuScene', 'Caribu', 'filterby_filterby', '_37075760', 'PARaggregators_PARaggregators', '_37075056', 'CaribuScene_newObjCaribuScene', 'Periodise_Periodise', 'vcaributest2', 'Canestra_Canestra', 'GenOutput_GenOutput', 'vcaribu_vcaribu', 'mtg_to_canestra', 'CaribuZenithPar', 'mydict_mydict', 'CarribuZenithParSoil', 'ScatteringOptions_ScatteringOptions', 'selectOutput_selectOutput', 'PARsums', 'lightString_lightString', 'debug', 'WriteCan_WriteCan', 'Tutorial']
...
_37075760 = CompositeNodeFactory(name='Directional gap fraction',
...
_37075056 = CompositeNodeFactory(name='vcaribu_test',
...
CaribuZenithPar = CompositeNodeFactory(name='CaribuZenithPar',
   ...
   '__in__': {'position': [167.5, 16.75], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [200.625, 372.5], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
