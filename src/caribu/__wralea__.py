...
_130521104 = CompositeNodeFactory(name='vcaribu_test',
   ...
   5: [  (0, 'PackageData(alinea.caribu.data, par.opt)'),
         (1, 'None'),
         (2, 'None')],
   6: [(0, "{'Hc': None, 'Nz': None, 'Ds': None, '1st': True, 'infinity': False}")],
   7: [],
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  },
...
CaribuScene_functional_runCaribu = Factory(name='Caribu',
                ...
                inputs=[{'interface': None, 'name': 'CaribuScene', 'value': None, 'desc': ''}, 
                        ...
                        {'interface': IDict, 'name': 'Multiple scattering options :', 'value': {'SphereDiameter': 0.5, 'Nz': 5, 'Zmax': 2, 'keepFF': False}, 'desc': 'Dictionary of parameters for multiple scaterring'}, 
                        {'interface': IBool, 'name': 'Consider Toric Canopy (infinite)', 'value': True},
