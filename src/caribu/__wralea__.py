...
# This file has been generated at Thu Jul 26 15:32:46 2012
...
__all__ = ['LIE', 'CaribuScene_getIncidentEnergy', 'reduceDict_reduceDict', 'CaribuScene_functional_newFileCaribuScene', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_functional_newCaribuScene', '_135514288', 'CarribuZenithParSoil', 'filterby_filterby', 'mtg_updateMTG', 'PARaggregators_PARaggregators', 'label_decode_label', '_135514832', 'CaribuScene_functional_WriteCan', 'CaribuScene_newObjCaribuScene', 'Periodise_Periodise', 'vcaributest2', 'Canestra_Canestra', 'CaribuScene_functional_addShapes', 'mtg_to_canestra', 'CaribuZenithPar', 'CaribuScene_functional_GenOutput', 'label_encode_label', 'CaribuScene_functional_runCaribu', 'caribu_vcaribu', 'mydict_mydict', 'CaribuScene_functional_addSoil', 'CaribuScene_functional_output_by_id', 'selectOutput_selectOutput', 'PARsums', 'Tutorial', 'debug', '_135514416', 'lightString_lightString']
...
_135514288 = CompositeNodeFactory(name='vcaribu_test',
...
CarribuZenithParSoil = CompositeNodeFactory(name='CarribuZenithParSoil',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'useUserColor': False, 'position': [401.8115542781534, 11.418437541630556], 'userColor': None},
   3: {'useUserColor': False, 'position': [130.98720317145722, 168.82277142056157], 'userColor': None},
   4: {  'position': [56.8620711240156, 101.4296403833792],
         'useUserColor': False,
         'userColor': None},
   5: {'useUserColor': False, 'position': [203.62829508722552, 116.35062467215072], 'userColor': None},
   ...
   11: {'useUserColor': False, 'position': [278.43042703347976, -28.827954318698602], 'userColor': None},
   13: {'useUserColor': False, 'position': [143.25047959371562, 46.22794321532277], 'userColor': None},
   '__in__': {'useUserColor': False, 'position': [180.86311239193083, -163.39121037463977], 'userColor': None},
   '__out__': {'useUserColor': False, 'position': [203.0446198457057, 265.7409722906167], 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_135514832 = CompositeNodeFactory(name='Directional gap fraction',
...
CaribuZenithPar = CompositeNodeFactory(name='CaribuZenithPar',
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  3: {'useUserColor': False, 'position': [154.4437992450155, 251.34250656600204], 'userColor': None},
   4: {'useUserColor': False, 'position': [174.9993200559596, 179.39628789656157], 'userColor': None},
   ...
   7: {  'position': [311.25, 77.5], 'useUserColor': False, 'userColor': None},
   8: {  'position': [210.0, 75.0], 'useUserColor': False, 'userColor': None},
   9: {'useUserColor': False, 'position': [356.78693961024334, 80.16767619411947], 'userColor': None},
   10: {'useUserColor': False, 'position': [249.28997549594638, 73.45451760902998], 'userColor': None},
   '__in__': {'useUserColor': False, 'position': [207.06322486503532, -27.30222969508967], 'userColor': None},
   '__out__': {'useUserColor': False, 'position': [215.13082402100522, 323.847891364252], 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_135514416 = CompositeNodeFactory(name='Caribu with turtle',
                             description='',
                             category='demo',
                             doc='',
                             inputs=[],
