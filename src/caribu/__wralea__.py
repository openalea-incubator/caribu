...
# This file has been generated at Tue Jul 24 15:10:47 2012
...
_134696848 = CompositeNodeFactory(name='Directional gap fraction',
...
CaribuScene_runCaribu = Factory(name='runCaribu',
                ...
                nodemodule='CaribuScene',
                nodeclass='runCaribu',
                inputs=[{'interface': None, 'name': 'CaribuScene', 'value': None, 'desc': ''}, {'interface': IBool, 'name': 'No Multiple Scaterring', 'value': True, 'desc': 'Turn off multiple scattering calculations'}, {'interface': IInt, 'name': 'number of layers', 'value': 10}, {'interface': IFloat, 'name': 'Canopy Height', 'value': 1}, {'interface': IFloat, 'name': 'Sphere diameter', 'value': 0.5}],
...
_134696912 = CompositeNodeFactory(name='vcaribu_test',
...
CaribuScene_functional_addShapes = Factory(name='addShapes',
                ...
                nodemodule='CaribuScene_functional',
                nodeclass='addShapes',
                inputs=[{'interface': None, 'name': 'CaribuScene', 'value': None, 'desc': ''}, {'interface': None, 'name': 'Shapes', 'value': None, 'desc': ''}, {'interface': None, 'name': 'Tesselator', 'value': None, 'desc': 'PlantGL tesselator instance or None'}, {'interface': None, 'name': 'CanLabels', 'value': None, 'desc': 'Labels used by Caribu to make the association between opticals properties and shapes (if None, uses opt=1 and opak = 0), see createLabels'}, {'interface': IBool, 'name': 'Copy Caribuscene', 'value': True, 'desc': 'uncheck only if you know what you do (pass by reference)'}],
...
_252913808 = CompositeNodeFactory(name='Caribu with turtle',
                             description='',
                             category='demo',
                             doc='',
                             inputs=[],
   ...
   24: {'useUserColor': False, 'position': [119.92458542639523, 20.606758242897726], 'userColor': None},
   25: {'useUserColor': False, 'position': [135.8592640284939, 63.618304307882795], 'userColor': None},
