...
# This file has been generated at Thu Dec 08 12:03:25 2011
...
__all__ = ['LIE', 'CaribuScene_getIncidentEnergy', 'vcaribuOut_adaptor_vcaribuOut_adaptor', '_61116880', 'reduceDict_reduceDict', 'vcaribu_adaptor_vcaribu_adaptor', 'addSoil_addSoil', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_newFileCaribuScene', 'Caribu', 'filterby_filterby', 'mtg_updateMTG', 'PARaggregators_PARaggregators', 'CaribuScene_newObjCaribuScene', 'Periodise_Periodise', 'vcaributest2', '_61116752', 'Canestra_Canestra', 'GenOutput_GenOutput', 'vcaribu_vcaribu', 'mtg_to_canestra', 'CaribuZenithPar', 'mydict_mydict', 'CarribuZenithParSoil', 'ScatteringOptions_ScatteringOptions', 'selectOutput_selectOutput', 'PARsums', 'lightString_lightString', 'debug', 'WriteCan_WriteCan', 'Tutorial']
...
_61116880 = CompositeNodeFactory(name='Directional gap fraction',
...
_61116752 = CompositeNodeFactory(name='vcaribu_test',
...
CaribuZenithPar = CompositeNodeFactory(name='CaribuZenithPar',
   ...
   10: ('alinea.caribu.data', 'zenith.light')},
                             elt_connections={  10019772: (6, 0, 3, 0),
   10019784: (3, 0, '__out__', 0),
   10019796: (3, 1, '__out__', 1),
   10019808: ('__in__', 1, 6, 2),
   10019820: (7, 0, 6, 3),
   10019832: ('__in__', 0, 6, 0),
   10019844: (9, 0, 7, 0),
   10019856: (10, 0, 8, 0),
   10019868: (8, 0, 6, 1)},
                             elt_data={  3: {  'block': False,
         'caption': 'Caribu',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0235BB50> : "Caribu"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'ObjCaribuScene',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0235B9F0> : "ObjCaribuScene"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'read',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x041BD130> : "read"',
         'hide': True,
         'id': 7,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': 'par4.opt',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x06D76690> : "par4.opt"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   10: {  'block': False,
          'caption': 'zenith.light',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x03C8DC90> : "zenith.light"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   9: {  'position': [307.54089979550093, 5.4192229038854798],
         'useUserColor': False,
         'userColor': None},
   10: {  'position': [191.25, 7.5], 'useUserColor': False, 'userColor': None},
   '__in__': {  'position': [167.5, 16.75],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [200.625, 372.5],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
CarribuZenithParSoil = CompositeNodeFactory(name='CarribuZenithParSoil',
   ...
   10: ('alinea.caribu.data', 'zenith.light')},
                             elt_connections={  10019696: (5, 0, 3, 0),
   10019708: (6, 0, 5, 0),
   10019720: (3, 0, '__out__', 0),
   10019732: (3, 1, '__out__', 1),
   10019744: ('__in__', 1, 6, 2),
   10019756: (7, 0, 6, 3),
   10019768: ('__in__', 0, 6, 0),
   10019780: (9, 0, 7, 0),
   10019792: (10, 0, 8, 0),
   10019804: (8, 0, 6, 1)},
                             elt_data={  3: {  'block': False,
         'caption': 'Caribu',
         'delay': 0,
         'factory': '<openalea.core.compositenode.CompositeNodeFactory object at 0x0220B190> : "Caribu"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   5: {  'block': False,
         'caption': 'addSoil',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0220B0B0> : "addSoil"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         'caption': 'ObjCaribuScene',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0220B270> : "ObjCaribuScene"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'read',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x0407E050> : "read"',
         'hide': True,
         'id': 7,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': 'par.opt',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x03BC4290> : "par.opt"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   10: {  'block': False,
          'caption': 'zenith.light',
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x03BC4390> : "zenith.light"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 119.86311239193083,
                'posy': 17.108789625360231,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   ...
   '__out__': []},
         ...
         'useUserColor': False,
         'userColor': None},
   5: {  'position': [157.95389048991359, 243.82564841498561],
         'useUserColor': False,
         'userColor': None},
   6: {  'position': [145.0, 186.25], 'useUserColor': False, 'userColor': None},
   7: {  'position': [311.25, 77.5], 'useUserColor': False, 'userColor': None},
   ...
   10: {  'position': [191.25, 7.5], 'useUserColor': False, 'userColor': None},
   '__in__': {  'position': [119.86311239193083, 17.108789625360231],
                'useUserColor': False,
                'userColor': None},
   '__out__': {  'position': [200.625, 369.5],
                 'useUserColor': False,
                 'userColor': None}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
...
Tutorial = CompositeNodeFactory(name='Tutorial',
   ...
   5: {'position': [367.06743030648192, 621.9407543154739], 'userColor': None, 'useUserColor': False},
   6: {'position': [-21.25, 16.25], 'userColor': None, 'useUserColor': False},
   7: {'position': [205.0, 17.5], 'userColor': None, 'useUserColor': False},
   8: {'position': [271.25, 66.25], 'userColor': None, 'useUserColor': False},
   9: {'position': [88.75, 67.5], 'userColor': None, 'useUserColor': False},
   10: {'position': [577.49999999999989, 472.49999999999989], 'userColor': None, 'useUserColor': False},
   ...
   14: {'position': [395.19512719420374, 557.58350938610783], 'userColor': None, 'useUserColor': False},
   15: {'position': [564.95436551557134, 621.52116088048047], 'userColor': None, 'useUserColor': False},
   16: {'position': [467.91545663099549, 519.8199993858218], 'userColor': None, 'useUserColor': False},
   17: {'position': [510.53419611406684, 518.87206808444103], 'userColor': None, 'useUserColor': False},
   18: {'position': [469.60352077632126, 558.80768301985836], 'userColor': None, 'useUserColor': False},
   19: {'position': [512.41424711877164, 556.50366064143952], 'userColor': None, 'useUserColor': False},
