...
_132861296 = CompositeNodeFactory(name='Directional gap fraction',
...
exposition_rain_and_light = Factory(name='Rain and Light Expositions',
                                    nodemodule = 'exposition',
                                    nodeclass = 'rain_and_light_expositions')
