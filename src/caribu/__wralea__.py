...
CaribuScene_getOutput = Factory(name='getOutput',
                ...
                nodemodule='CaribuScene',
                nodeclass='getOutput',
                inputs=[{'interface': None, 'name': 'CaribuScene', 'value': None, 'desc': ''}, {'interface': IEnumStr(enum=['Area', 'Eabs', 'Einc', 'Eabsm2', 'EiInf', 'EiSup']), 'name': 'Variable', 'value': 'Einc', 'desc': 'Eabs is absorbed radiation, Einc is incident radiation on objects'}, {'interface': IBool, 'name': 'aggregate', 'value': True, 'desc': 'should results (one per triangle) be aggregated by objects ?'}],
