...
# This file has been generated at Thu Jul 26 11:15:05 2012
...
__all__ = ['LIE', 'CaribuScene_getIncidentEnergy', 'reduceDict_reduceDict', 'CaribuScene_functional_newFileCaribuScene', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_functional_newCaribuScene', 'CarribuZenithParSoil', 'filterby_filterby', 'mtg_updateMTG', '_140577552', 'PARaggregators_PARaggregators', 'label_decode_label', 'CaribuScene_functional_WriteCan', '_140578000', 'CaribuScene_newObjCaribuScene', 'Periodise_Periodise', 'vcaributest2', 'Canestra_Canestra', 'CaribuScene_functional_addShapes', 'mtg_to_canestra', 'CaribuZenithPar', 'CaribuScene_functional_GenOutput', 'label_encode_label', 'CaribuScene_functional_runCaribu', 'caribu_vcaribu', '_140578704', 'mydict_mydict', 'CaribuScene_functional_addSoil', 'CaribuScene_functional_output_by_id', 'selectOutput_selectOutput', 'PARsums', 'Tutorial', 'debug', 'lightString_lightString']
...
CarribuZenithParSoil = CompositeNodeFactory(name='CarribuZenithParSoil',
   ...
   10: ('alinea.caribu.data', 'zenith.light')},
                             elt_connections={  30389668: ('__in__', 0, 4, 0),
   30389680: (6, 0, 5, 0),
   30389692: (3, 1, '__out__', 1),
   30389704: (10, 0, 8, 0),
   30389716: (9, 0, 7, 0),
   30389728: (4, 0, 6, 0),
   30389740: (3, 0, '__out__', 0),
   30389752: (5, 0, 3, 0),
   30389764: (7, 0, 6, 3),
   30389776: ('__in__', 1, 6, 2),
   30389788: (8, 0, 6, 1)},
                             elt_data={  3: {  'block': False,
         'caption': 'Caribu',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x08610F50> : "Caribu"',
         'hide': True,
         'id': 3,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   4: {  'block': False,
         'caption': 'to_canestra',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x08301E30> : "to_canestra"',
         'hide': True,
         'id': 4,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   5: {  'block': False,
         'caption': 'addSoil',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x08610FD0> : "addSoil"',
         'hide': True,
         'id': 5,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   6: {  'block': False,
         ...
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x08610DF0> : "ObjCaribuScene"',
         'hide': True,
         'id': 6,
         'lazy': True,
         'port_hide_changed': set(),
   ...
   7: {  'block': False,
         'caption': 'read',
         'delay': 0,
         'factory': '<openalea.core.node.NodeFactory object at 0x09ABF630> : "read"',
         'hide': True,
         'id': 7,
         'lazy': False,
         'port_hide_changed': set(),
   ...
   9: {  'block': False,
         'caption': 'par.opt',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x082D31D0> : "par.opt"',
         'hide': True,
         'id': 9,
         'lazy': True,
   ...
   10: {  'block': False,
          ...
          'delay': 0,
          'factory': '<openalea.core.data.DataFactory object at 0x082D30F0> : "zenith.light"',
          'hide': True,
          'id': 10,
          'lazy': True,
          'port_hide_changed': set([2]),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 151.86311239193083,
                'posy': -75.39121037463977,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   ...
   4: {'position': [56.8620711240156, 101.4296403833792], 'userColor': None, 'useUserColor': False},
   5: {'position': [157.9538904899136, 243.8256484149856], 'userColor': None, 'useUserColor': False},
   ...
   '__in__': {'position': [151.86311239193083, -75.39121037463977], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [183.67858429394812, 424.0], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_140577552 = CompositeNodeFactory(name='vcaribu_test',
...
_140578000 = CompositeNodeFactory(name='Caribu with turtle',
                             description='',
                             category='demo',
                             doc='',
                             inputs=[],
...
CaribuZenithPar = CompositeNodeFactory(name='CaribuZenithPar',
   ...
   10: ('alinea.caribu.data', 'zenith.light')},
                             elt_connections={  30389680: ('__in__', 1, 6, 2),
   30389692: (7, 0, 6, 3),
   30389704: (3, 1, '__out__', 1),
   30389716: (10, 0, 8, 0),
   30389728: (5, 0, 6, 0),
   30389740: ('__in__', 0, 5, 0),
   30389752: (9, 0, 7, 0),
   30389764: (8, 0, 6, 1),
   30389776: (3, 0, '__out__', 0),
   30389788: (6, 0, 3, 0)},
                             elt_data={  3: {  'block': False,
         'caption': 'Caribu',
         'delay': 0,
   ...
   9: {  'block': False,
         'caption': 'par4.opt',
         'delay': 0,
         'factory': '<openalea.core.data.DataFactory object at 0x082D31F0> : "par4.opt"',
         'hide': True,
         'id': 9,
         'lazy': True,
         'port_hide_changed': set([2]),
   ...
   '__in__': {  'block': False,
                ...
                'lazy': True,
                'port_hide_changed': set(),
                'posx': 124.4202172096909,
                'posy': -70.33187134502924,
                'priority': 0,
                'use_user_color': False,
                'user_application': None,
                'user_color': None},
   ...
   5: {'position': [49.53717627401838, 112.23266499582289], 'userColor': None, 'useUserColor': False},
   6: {'position': [145.0, 186.25], 'userColor': None, 'useUserColor': False},
   7: {'position': [311.25, 77.5], 'userColor': None, 'useUserColor': False},
   8: {'position': [210.0, 75.0], 'userColor': None, 'useUserColor': False},
   9: {'position': [307.54089979550093, 5.41922290388548], 'userColor': None, 'useUserColor': False},
   10: {'position': [191.25, 7.5], 'userColor': None, 'useUserColor': False},
   '__in__': {'position': [124.4202172096909, -70.33187134502924], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [181.86635860484546, 427.0], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             eval_algo='LambdaEvaluation',
                             )
...
_140578704 = CompositeNodeFactory(name='Directional gap fraction',
...
debug = CompositeNodeFactory(name='debug',
   ...
   13: [(1, "'Opt'")],
   14: [  (0, 'True'),
          (1, "{'SphereDiameter': 0.5, 'Nz': 5, 'Zmax': 2}")],
   15: [],
   16: [],
   17: [],
   18: [],
