...
# This file has been generated at Fri Aug 03 10:30:42 2012
...
__all__ = ['LIE', 'CaribuScene_functional_newFileCaribuScene', 'reduceDict_reduceDict', 'CaribuScene_functional_generate_scene', 'MCSail_MCSail', 'S2v_S2v', 'CaribuScene_functional_newCaribuScene', 'CarribuZenithParSoil', '_130783952', 'filterby_filterby', 'mtg_updateMTG', 'PARaggregators_PARaggregators', 'label_decode_label', 'CaribuScene_functional_WriteCan', 'vcaributest2', 'CaribuScene_functional_newObjCaribuScene', 'Canestra_Canestra', 'CaribuScene_functional_addShapes', 'mtg_to_canestra', 'CaribuZenithPar', 'CaribuScene_functional_GenOutput', 'label_encode_label', 'CaribuScene_functional_runCaribu', 'caribu_vcaribu', 'CaribuScene_functional_periodise', 'mydict_mydict', 'CaribuScene_functional_addSoil', 'CaribuScene_functional_output_by_id', 'CaribuScene_functional_getIncidentEnergy', 'selectOutput_selectOutput', '_130783184', 'PARsums', 'Tutorial', 'debug', '_130784208', '_206193360', 'lightString_lightString', 'CaribuScene_functional_getEi']
...
_130783952 = CompositeNodeFactory(name='Directional gap fraction',
...
_130783184 = CompositeNodeFactory(name='Caribu with turtle',
                             description='',
                             category='demo',
                             doc='',
                             inputs=[],
...
_130784208 = CompositeNodeFactory(name='vcaribu_test',
...
_206193360 = CompositeNodeFactory(name='Povray with periodise',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[],
   ...
   '__in__': [],
   '__out__': []},
                             elt_ad_hoc={  2: {'position': [76.1758091989932, 422.3418282172029], 'userColor': None, 'useUserColor': False},
   3: {'position': [56.25122377259794, 188.7852597416065], 'userColor': None, 'useUserColor': False},
   4: {'position': [-229.63761240315165, 367.892752248063], 'userColor': None, 'useUserColor': False},
   5: {'position': [73.28305695093019, 461.876108940731], 'userColor': None, 'useUserColor': False},
   ...
   10: {'position': [5.785504496126052, 366.41528475465094], 'userColor': None, 'useUserColor': False},
   11: {'position': [26.999020981921646, 531.3021628942438], 'userColor': None, 'useUserColor': False},
   12: {'position': [26.034770232567297, 571.8006943671263], 'userColor': None, 'useUserColor': False},
   13: {'position': [115.71008992252135, 288.310974056949], 'userColor': None, 'useUserColor': False},
   14: {'useUserColor': False, 'position': [102.56807193801707, 366.7727772611074], 'userColor': None},
   15: {'useUserColor': False, 'position': [125.71008992252135, 528.7669031526374], 'userColor': None},
   16: {'useUserColor': False, 'position': [124.745839173167, 570.2296853748742], 'userColor': None},
   17: {'position': [208.27816186053846, 466.69736268750273], 'userColor': None, 'useUserColor': False},
   18: {'position': [236.2414335918144, 553.4799301293938], 'userColor': None, 'useUserColor': False},
   19: {'position': [296.9892308011381, 552.5156793800395], 'userColor': None, 'useUserColor': False},
