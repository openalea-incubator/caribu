...
from openalea.core import IEnumStr, IFileStr, IFloat, IInt, ISequence, IStr
...
__all__ = ['Normalise_Sky', '_98394928', 'GetLight', '_98394576',
           'GenSky', 'add_sun', 'merge2skies',
           'mergeNskies', 'get_meteo_dat',
           'GenSkyFile', 'Filename', 'Genlight',
           'GetLightsSun', 'group_seq',
           'place_sun', 'SkyPlusSun', '_98394864',
           'spitters_horaire', 'Gensun',
           'read_meteo_file', '_98394608']

turtle = Fa(uid="24e4eb784e8511e6bff6d4bed973e64a",
            name='Turtle',
            description='Turtle Sky in different formats (uoc, soc)',
            category='scene, sky',
            nodemodule='alinea.Caribu.sky_tools.turtle',
            nodeclass='turtle',
            inputs=[dict(name='sectors', interface=IEnumStr(['16', '46']),
                         value='16'),
                    dict(name='format', interface=IEnumStr(['soc', 'uoc']),
                         value='soc'),
                    {'name': 'Energy', 'interface': IFloat, 'value': 1.0,
                     'desc': 'energy flux measured on an horizontal surface'}, ],
...
Normalise_Sky = Fa(uid="24e4eb794e8511e6bff6d4bed973e64a",
                   name='Normalise_Sky',
                   description='Set Rs to 1 - intensity repartition by sectors remains unchanged ',
                   category='scene.sky',
                   nodemodule='alinea.Caribu.sky_tools.Normalise_Sky',
                   nodeclass='Normalise_Sky',
                   inputs=[{'interface': None, 'name': 'Sky', 'value': None,
                            'desc': ''}],
                   outputs=[{'interface': None, 'name': 'Normalised Sky',
                             'desc': ''}],
                   widgetmodule=None,
                   widgetclass=None,
                   )

_98394928 = CNF(uid="24e4eb724e8511e6bff6d4bed973e64a",
                name='GenSkies_Example',
                ...
                elt_value={2: [(2, 'None')],
                           ...
                           9: [(0, '3')],
                           10: [(0,
                                 'PackageData(alinea.caribu.data, Meteo2006.csv)'),
                                (1, 'None'),
                                (2, 'None')],
                           '__in__': [],
                           '__out__': []},
...
GetLight = Fa(uid="24e4eb7a4e8511e6bff6d4bed973e64a",
              name='GetLight',
              description='Get the incident light and the coordinates of sky sectors ',
              category='io,scene.light',
              nodemodule='alinea.Caribu.sky_tools.GetLight',
              nodeclass='GetLight',
              inputs=[{'interface': None, 'name': 'SkyObject', 'value': None,
                       'desc': ''}],
...
_98394576 = CNF(uid="24e4eb734e8511e6bff6d4bed973e64a",
                name='essai1_loop',
                description='',
                ...
                elt_factory={2: ('openalea.flow control', 'annotation'),
                             ...
                             10: (
                                 'alinea.Caribu.Sky_tools', 'write_light_file'),
                             ...
                             30: (
                                 'alinea.Caribu.Sky_tools', 'spitters_horaire'),
                ...
                elt_data={2: {'posx': -77.291014019941002,
                          ...
                          20: {'block': False,
                               ...
                               'priority': 0,
                               'user_application': None},
                          21: {'posx': 448.8518972098492,
                               'posy': 342.04871350782417, 'txt': 'Loop'},
                          22: {'block': False,
                               'caption': 'X0',
                               'hide': True,
                               'lazy': True,
                ...
                elt_value={2: [],
                           ...
                           12: [(0,
                                 "'C:/Documents and Settings/Karine/ex_RdRg_2J.csv'")],
                           13: [],
                           14: [(1, "'sky.light'")],
                           15: [],
                           16: [],
                           ...
                           18: [],
                           19: [(0,
                                 'PackageData(alinea.caribu.data, Rg_2J.csv)'),
                                (1, 'None'),
                                (2, 'None')],
                           20: [],
                           21: [],
...
GenSky = Fa(uid="24e4eb7b4e8511e6bff6d4bed973e64a",
            name='gensky',
            description='Create a discretised sky',
            category='scene.light',
            nodemodule='alinea.Caribu.sky_tools.GenSky',
            nodeclass='GenSky',
            inputs=[
                {'interface': IFloat, 'name': 'Global Energy', 'value': 1.0},
                {'interface': IEnumStr(enum=['soc', 'uoc']), 'name': 'Sky type',
                 'value': 'soc'},
...
add_sun = Fa(uid="24e4eb7c4e8511e6bff6d4bed973e64a",
             name='add_sun',
             description='add sun as a supplementary light source in a sky object',
             category='Unclassified',
             nodemodule='alinea.Caribu.sky_tools.add_sun',
             nodeclass='add_sun',
             inputs=[
                 {'interface': None, 'name': 'sky', 'value': None, 'desc': ''},
                 {'interface': None, 'name': 'sun', 'value': None, 'desc': ''}],
             outputs=[{'interface': None, 'name': 'sky', 'desc': ''}],
             widgetmodule=None,
             widgetclass=None,
             )

merge2skies = Fa(uid="24e4eb7d4e8511e6bff6d4bed973e64a",
                 name='merge2skies',
                 description='add light souces of two skies having similar discretisations',
                 category='codec,scene.sky',
                 nodemodule='alinea.Caribu.sky_tools.merge2skies',
                 nodeclass='merge2skies',
                 inputs=[
                     {'interface': None, 'name': 'Sky object1', 'value': None},
                     {'interface': None, 'name': 'Sky object2', 'value': None}],
                 outputs=[{'interface': None, 'name': 'Sky object'}],
                 widgetmodule=None,
                 widgetclass=None,
                 )

mergeNskies = Fa(uid="259cd4804e8511e6bff6d4bed973e64a",
                 name='mergeNskies',
                 description='',
                 category='scene.sky',
                 nodemodule='alinea.Caribu.sky_tools.mergeNskies',
                 nodeclass='mergeNskies',
                 inputs=[{'interface': ISequence, 'name': 'list of sky objects',
                          'value': None}],
                 outputs=[{'interface': None, 'name': 'sky object'}],
                 widgetmodule=None,
                 widgetclass=None,
...
get_meteo_dat = Fa(uid="259cd4814e8511e6bff6d4bed973e64a",
                   name='get_meteo_dat',
                   description='',
                   category='IO,scene.sky',
                   nodemodule='alinea.Caribu.sky_tools.get_meteo_dat',
                   nodeclass='get_meteo_dat',
                   inputs=[{'interface': None, 'name': 'meteo table',
                            'value': None},
                           {'interface': IInt, 'name': 'group', 'value': 0},
                           {'interface': IInt, 'name': 'indice', 'value': 1}],
                   outputs=[{'interface': IFloat, 'name': 'Rd'},
                            {'interface': IFloat, 'name': 'Rsun'},
                            {'interface': IInt, 'name': 'DOY'},
                            {'interface': None, 'name': 'HU'}],
                   widgetmodule=None,
                   widgetclass=None,
                   )

GenSkyFile = CNF(uid="24e4eb744e8511e6bff6d4bed973e64a",
                 name='GenSkyFile',
                 description='Generate one light file from one group number (one day for example)',
                 category='scene.sky',
                 doc='',
                 inputs=[{'desc': '', 'interface': None, 'name': 'meteo table',
                          'value': None},
                         {'desc': '', 'interface': IInt, 'name': 'Data group',
                          'value': None},
                         {'desc': '',
                          'interface': IEnumStr(enum=['soc', 'uoc']),
                          'name': 'Sky type',
                          'value': 'soc'},
                         {'desc': '', 'interface': IInt, 'name': 'Nb Azimut',
                          'value': None},
                         {'desc': '', 'interface': IInt, 'name': 'Nb Zenith',
                          'value': None},
                         {'desc': '', 'interface': IFloat, 'name': 'Latitude',
                          'value': None}],
...
Filename = Fa(uid="259cd4824e8511e6bff6d4bed973e64a",
              name='Filename',
              description='Build a filename function of group',
              category='io',
              nodemodule='alinea.Caribu.sky_tools.Filename',
              nodeclass='Filename',
              inputs=[{'interface': IInt, 'name': 'Group', 'value': None,
                       'desc': ''}],
...
Genlight = Fa(uid="259cd4834e8511e6bff6d4bed973e64a",
              name='write_light_file',
              description='Write a .light file',
              category='IO',
              nodemodule='alinea.Caribu.sky_tools.Genlight',
              nodeclass='Genlight',
              inputs=[
...
GetLightsSun = Fa(uid="259cd4844e8511e6bff6d4bed973e64a",
                  name='GetLightSun',
                  description='',
                  category='data i/o',
                  nodemodule='alinea.Caribu.sky_tools.GetLightsSun',
                  nodeclass='GetLightsSun',
                  inputs=[
                      {'interface': None, 'name': 'Sun object', 'value': None,
                       'desc': ''}],
                  outputs=[
                      {'interface': None, 'name': 'light string', 'desc': ''}],
                  widgetmodule=None,
                  widgetclass=None,
                  )

group_seq = Fa(uid="259cd4854e8511e6bff6d4bed973e64a",
               name='group_seq',
               description='sequence of meteorological data indices',
               category='IO',
               nodemodule='alinea.Caribu.sky_tools.group_seq',
               nodeclass='group_seq',
               inputs=[
                   {'interface': None, 'name': 'meteo table', 'value': None},
                   {'interface': IInt, 'name': 'data group', 'value': None}],
               outputs=[{'interface': None, 'name': 'sequence'}],
               widgetmodule=None,
               widgetclass=None,
               )

place_sun = Fa(uid="259cd4864e8511e6bff6d4bed973e64a",
               name='place_sun',
               description='Place sun light in a discretised sky',
               category='scene.light',
               nodemodule='alinea.Caribu.sky_tools.place_sun',
               nodeclass='place_sun',
               inputs=[{'interface': IInt, 'name': 'Nb azimut', 'value': 8},
                       {'interface': IInt, 'name': 'Nb zenith', 'value': 6},
                       {'interface': None, 'name': 'sun object',
                        'value': None}],
               outputs=[{'interface': None, 'name': 'sky object'}],
               widgetmodule=None,
               widgetclass=None,
...
SkyPlusSun = CNF(uid="24e4eb754e8511e6bff6d4bed973e64a",
                 name='SkyPlusSun',
                 ...
                 elt_data={2: {'block': False,
                           ...
                           '__out__': {'block': False,
                                       ...
                                       'priority': 0,
                                       'user_application': None}},
                 elt_value={2: [(0, '0.0'), (1, '1'), (2, '1.0'),
                                (3, '49.869999999999997')],
                            3: [],
...
_98394864 = CNF(uid="24e4eb764e8511e6bff6d4bed973e64a",
                name='gensky_group',
                ...
                inputs=[
                    ...
                    {'interface': IFloat, 'name': 'Latitude',
                    ...
                    {'interface': IEnumStr(enum=['soc', 'uoc']),
                     ...
                     'value': 'soc'}],
                outputs=[{'interface': None, 'name': 'sky object'}],
                elt_factory={19: ('alinea.Caribu.Sky_tools', 'group_seq'),
                             20: ('openalea.function operator', 'map'),
                             21: ('openalea.flow control', 'annotation'),
                             22: ('openalea.flow control', 'X'),
                             23: ('alinea.Caribu.Sky_tools', 'gensky'),
                             ...
                             29: ('alinea.Caribu.Sky_tools', 'merge2skies'),
                             35: ('openalea.flow control', 'annotation'),
                             39: ('alinea.Caribu.Sky_tools', 'GetLight'),
                             40: ('alinea.Caribu.Sky_tools', 'get_meteo_dat')},
                ...
                elt_data={19: {'caption': 'group_seq',
                          ...
                          20: {'caption': 'map',
                               ...
                               'priority': 0,
                               'user_application': None},
                          21: {'posx': 531.4115809337253,
                               'posy': 263.83566144122176, 'txt': 'Loop'},
                          22: {'caption': 'X0',
                               'hide': True,
                               'lazy': True,
                               'minimal': False,
...
spitters_horaire = Fa(uid="259cd4874e8511e6bff6d4bed973e64a",
                      name='spitters_horaire',
                      description='add RdRs to meteo table; use Rg measurements, hourly data',
                      category='Unclassified',
                      nodemodule='alinea.Caribu.sky_tools.spitters_horaire',
                      nodeclass='spitters_horaire',
                      inputs=[{'interface': ISequence, 'name': 'meteo table',
                               'value': None},
                              {'interface': IFloat, 'name': 'latitude',
                               'value': 49.869999999999997}],
...
Gensun = Fa(uid="259cd4884e8511e6bff6d4bed973e64a",
            name='gensun',
            description='Create a Sun object',
            category='scene.sky',
            nodemodule='alinea.Caribu.sky_tools.Gensun',
            nodeclass='Gensun',
            inputs=[{'interface': IFloat, 'name': 'Rsun', 'value': 0.0},
                    {'interface': IInt, 'name': 'DOY', 'value': 1},
                    {'interface': IFloat, 'name': 'heureTU', 'value': 12},
                    {'interface': IFloat, 'name': 'lat',
                     'value': 49.869999999999997}],
...
read_meteo_file = Fa(uid="259cd4894e8511e6bff6d4bed973e64a",
                     name='read_meteo_file',
                     description='read a meteo file [DOY,HU,Rg(,RdRs),Group] and generate a list of table by Group',
                     category='IO',
                     nodemodule='alinea.Caribu.sky_tools.read_meteo_file',
                     nodeclass='read_meteo_file',
                     inputs=[{'interface': IFileStr, 'name': 'meteo file',
                              'value': 'ex_RdRg_2J.csv'}],
                     outputs=[
                         {'interface': ISequence, 'name': 'meteo sequence'}],
                     widgetmodule=None,
                     widgetclass=None,
                     )

_98394608 = CNF(uid="24e4eb774e8511e6bff6d4bed973e64a",
                name='gensky_rg',
                ...
                inputs=[{'interface': IFloat, 'name': 'Rd', 'value': 1.0},
                        ...
                        {'interface': IFloat, 'name': 'latitude',
                         'value': 49.869999999999997}],
                outputs=[{'interface': None, 'name': 'sky object'}],
                elt_factory={2: ('alinea.Caribu.Sky_tools', 'gensky'),
                             3: ('alinea.Caribu.Sky_tools', 'gensun'),
                             4: ('alinea.Caribu.Sky_tools', 'place_sun'),
                             5: ('alinea.Caribu.Sky_tools', 'merge2skies'),
                             6: ('alinea.Caribu.Sky_tools', 'add_sun')},
                elt_connections={27614152: (6, 0, '__out__', 0),
                                 27614164: (3, 0, 6, 1),
                                 27614176: ('__in__', 3, 4, 1),
                                 27614188: ('__in__', 0, 2, 0),
                                 27614200: ('__in__', 6, 3, 2),
                                 27614212: (3, 0, 4, 2),
                                 27614224: ('__in__', 7, 3, 3),
                                 27614236: (2, 0, 5, 0),
                                 27614248: (4, 0, 5, 1),
                                 27614260: ('__in__', 2, 4, 0),
                                 27614272: ('__in__', 2, 2, 2),
                                 27614284: ('__in__', 4, 3, 0),
                                 27614296: ('__in__', 3, 2, 3),
                                 27614308: ('__in__', 1, 2, 1),
                                 27614320: (2, 0, 6, 0),
                                 27614332: ('__in__', 5, 3, 1)},
                elt_data={2: {'block': False,
                              'caption': 'gensky',
                              'hide': True,
                          ...
                          5: {'block': False,
                              ...
                              'minimal': False,
                              'port_hide_changed': set(),
                              'posx': 425.11396011396005,
                              'posy': 570.44254510921178,
                              'priority': 0,
                              'use_user_color': False,
                              'user_application': None,
                              'user_color': None},
                          6: {'block': False,
                              ...
                              'lazy': True,
                              'port_hide_changed': set(),
                              'posx': 322.27160493827148,
                              'posy': 582.56790123456778,
                              'priority': 0,
                              'use_user_color': False,
                              'user_application': None,
                              'user_color': None},
                          ...
                          '__out__': {'block': False,
                                      ...
                                      'minimal': False,
                                      'port_hide_changed': set(),
                                      'posx': 334.15147198480531,
                                      'posy': 649.51187084520427,
                                      'priority': 0,
                                      'use_user_color': False,
                                      'user_application': None,
                                      'user_color': None}},
                elt_value={2: [], 3: [], 4: [], 5: [], 6: [], '__in__': [],
                           '__out__': []},
                elt_ad_hoc={2: {'position': [242.5, 352.5], 'userColor': None,
                                'useUserColor': False},
                            3: {'position': [452.5, 338.75], 'userColor': None,
                                'useUserColor': False},
                            4: {'position': [437.5, 456.25], 'userColor': None,
                                'useUserColor': False},
                            5: {'position': [425.11396011396005,
                                             570.44254510921178],
                                'userColor': None, 'useUserColor': False},
                            6: {'position': [322.27160493827148,
                                             582.56790123456778],
                                'userColor': None, 'useUserColor': False},
                            '__in__': {'position': [347.5, 278.75],
                                       'userColor': None,
                                       'useUserColor': False},
                            '__out__': {'position': [334.15147198480531,
                                                     649.51187084520427],
                                        'userColor': None,
                                        'useUserColor': False}},
                lazy=True,
