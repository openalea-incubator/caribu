...
# This file has been generated at Tue Jul 19 18:25:27 2016
...
__all__ = ['LIE', 'PARsums', 'CaribuZenithParSoil', '_359376240', 'CaribuZenithPar']
...
LIE = CompositeNodeFactory(name='LIE',
   ...
   5: {  'position': [-405.42793462109955, 371.1664190193165],
         'useUserColor': False,
         'userColor': None},
   6: {'position': [-533.7919427614792, 222.4636862244897], 'userColor': None, 'useUserColor': False},
   7: {'position': [-510.21562818877516, 261.7575438456631], 'userColor': None, 'useUserColor': False},
   8: {'position': [-363.4230179367439, 105.12029226809597], 'userColor': None, 'useUserColor': False},
   9: {'position': [-499.6174107142858, 99.42008928571431], 'userColor': None, 'useUserColor': False},
   10: {'position': [-477.5060690369899, 220.5025031887753], 'userColor': None, 'useUserColor': False},
   11: {  'position': [-216.25000000000003, 426.25000000000006],
          'useUserColor': False,
          'userColor': None},
   '__in__': {'position': [-392.63973214285716, -55.56339285714286], 'userColor': None, 'useUserColor': False},
   '__out__': {'position': [-408.48287228954086, 311.1406377551018], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
...
_359376240 = CompositeNodeFactory(name='Directional gap fraction',
   ...
   '__out__': {  'block': False,
                 ...
                 'priority': 0,
                 'user_application': None}},
                             elt_value={  2: [(1, 'True'), (2, "{'d_sphere': 0.5, 'layers': 5, 'height': 2}")],
   4: [],
   5: [(1, "'EiSup'")],
